...
# llm сервер держит контекст 8192+ токенов, в русском это примерно 4 символа на токен
# оставляем запас под системный промпт и ответ, поэтому берём ~24000 символов
# раньше тут стояло 6000 и длинные встречи теряли почти весь разговор
